                    ...
                    <div class="form-card p-1">
                        ...
                        <form id="verificationForm" method="POST" action="/verify">
                            ...
                            <div class="d-grid gap-1 d-md-flex justify-content-md-end">
                                ...
                                <button type="button" class="btn btn-outline-info btn-sm me-md-1" id="previewBtn">
                                    <i class="fas fa-eye me-1"></i>প্রিভিউ দেখুন
                                </button>
            ...
            <div class="modal-content">
                <div class="modal-header bg-info text-white">
                    <h5 class="modal-title" id="formPreviewModalLabel">
                        <i class="fas fa-eye me-2"></i>ফর্ম ডেটা প্রিভিউ
                    </h5>
                ...
                <div class="modal-body">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">জমা দেওয়ার আগে আপনার প্রবেশকৃত তথ্য পর্যালোচনা করুন</p>
                    </div>
                    ...
                    <div class="preview-section mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">এনআইডি ধরন</div>
                                    <div class="info-value" id="previewNidType">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">এনআইডি নম্বর</div>
                                    <div class="info-value" id="previewNidValue">-</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="preview-section mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">ইংরেজি নাম</div>
                                    <div class="info-value" id="previewNameEn">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">বাংলা নাম</div>
                                    <div class="info-value" id="previewName">-</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div class="info-value" id="previewDateOfBirth">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">পিতার নাম</div>
                                    <div class="info-value" id="previewFather">-</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    ...
                                    <div class="info-value" id="previewMother">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">স্বামী/স্ত্রীর নাম</div>
                                    <div class="info-value" id="previewSpouse">-</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="preview-section mb-4">
                        <h6 class="fw-bold text-primary mb-3">
                            <i class="fas fa-map-marker-alt me-2"></i>স্থায়ী ঠিকানা
                        </h6>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">বিভাগ</div>
                                    <div class="info-value" id="previewPermanentDivision">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">জেলা</div>
                                    <div class="info-value" id="previewPermanentDistrict">-</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">উপজেলা</div>
                                    <div class="info-value" id="previewPermanentUpazila">-</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="preview-section mb-4">
                        <h6 class="fw-bold text-primary mb-3">
                            <i class="fas fa-home me-2"></i>বর্তমান ঠিকানা
                        </h6>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">বিভাগ</div>
                                    <div class="info-value" id="previewPresentDivision">-</div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">জেলা</div>
                                    <div class="info-value" id="previewPresentDistrict">-</div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="info-item">
                                    <div class="info-label">উপজেলা</div>
                                    <div class="info-value" id="previewPresentUpazila">-</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i>
                        <strong>সতর্কতা:</strong> যদি কোন তথ্য ভুল হয়, তাহলে ফর্মটি সম্পাদনা করুন এবং আবার প্রিভিউ দেখুন।
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="proceedToSubmitBtn">
                        <i class="fas fa-check me-1"></i>ঠিক আছে, জমা দিন
                    </button>
                </div>
            </div>
        </div>
